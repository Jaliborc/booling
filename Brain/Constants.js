...
Errors = {
  'SHORT': ["I can't make anything with just one character. Are you too lazy to type more? ARE YOU A WEAKLING!?", "Do you happen to be a chicken? Only chickens can't type more than a single character.", "Kid, type more than one character or this ain't go anywhere. And you do not want to see me bored...", "Are you trying to get me mad? Type more than one character! NOW!!"],
  ...
  'DOUBLE OPER': ["Hey jackass, there must be a variable between those two. Got it?", "WHAT ARE YOU DOING!?"],
  'MISSING OPER': ["Hey jackass, there must be an operator between those two. Got it?"],
  'MISSING VAR': ["Hey jackass, there must be a variable between those two. Got it?"],
  'NUM BRACKETS': ["Kid, are you still in grade school? 'Cause the number of brackets do not match.", 'Do you know how to count, or should I "teach" you? Check the number of brackets.'],
