...
Errors =
	'SHORT' : [
		...
		"Do you happen to be a chicken? Only chickens have trouble typing more than two characters."
		"Kid, type more than two characters or this won't lead us anywhere. And you do not want to see me bored..."
		"Are you trying to get me mad? Just type more than two characters."
	]
	'DOUBLE VAR': [
	...
	'NUM BRACKETS': [
		"Kid, are you still in grade school? Because the number of brackets do not match."
